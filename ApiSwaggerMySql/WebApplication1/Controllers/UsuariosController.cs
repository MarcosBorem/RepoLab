...
namespace WebApplication1.Controllers
{
    ...
    {
        private readonly DbFirstPostgresContext _context;

        public UsuariosController(DbFirstPostgresContext context)
        {
            _context = context;
        }
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutUsuarioAsync(int id, Usuario usuario)
        {
            if (id != usuario.Id)
            {
                return BadRequest();
